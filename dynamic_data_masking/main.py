...
from dynamic_data_masking.mappers import LANG_MAP, CONF_LEVEL_MAP

parser = argparse.ArgumentParser(description="Arguments parser for dynamic data masking engine")
# FILE PROCESSOR STEP ARGUMENTS
parser.add_argument("input_file_path", type='str', help='paht to the file required masking')
...
# REDACTOR STEP
parser.add_argument("--output_file_path", type='str', help="path to where the masked file will be generated")
...
if __name__ == "__main__":
    ...
    pipeline.add_step(RedactorStep(input_file_path=args.input_file_path, output_pdf_path=args.output_file_path))
